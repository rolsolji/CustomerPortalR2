...
exports.chats = [
    {
        ...
        unreadCount: 5,
        timestamp: luxon_1.DateTime.local().minus({ minutes: 10 }).toRelative()
    },
    {
        id: 2,
        ...
        unreadCount: 2,
        timestamp: luxon_1.DateTime.local().minus({ minutes: 54 }).toRelative()
    },
    {
        id: 3,
        ...
        unreadCount: 4,
        timestamp: luxon_1.DateTime.local().minus({ hours: 2 }).toRelative()
    },
    {
        id: 4,
        ...
        message: 'Thanks! 👍👍👍',
        unreadCount: 0,
        timestamp: luxon_1.DateTime.local().minus({ hours: 8 }).toRelative()
    },
    {
        id: 5,
        ...
        unreadCount: 0,
        timestamp: luxon_1.DateTime.local().minus({ day: 1 }).toRelative()
    },
    {
        id: 6,
    ...
    },
    {
        ...
        unreadCount: 0,
        timestamp: luxon_1.DateTime.local().minus({ day: 2 }).toRelative()
    },
    {
        id: 8,
    ...
    },
    {
        ...
        unreadCount: 0,
        timestamp: luxon_1.DateTime.local().minus({ day: 30 }).toRelative()
    },
    {
        id: 10,
